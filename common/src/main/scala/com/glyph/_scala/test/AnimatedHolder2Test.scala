...
import com.glyph._scala.game.action_puzzle.view.animated.{AnimatedTable, AnimatedPuzzleTable, Menu}
import com.glyph._scala.lib.libgdx.actor.transition.AnimatedManager.AnimatedConstructor
import com.badlogic.gdx.graphics.{Color, Texture}
import com.glyph._scala.lib.libgdx.actor.{Tasking, SpriteActor}
import com.glyph._scala.lib.util.extraction.{ExtractableFunctionFuture, ExtractableFuture, Extractable, ExtractableFunction0}
