...
import com.glyph._scala.lib.libgdx.TextureUtil
import com.glyph._scala.lib.util.reactive.{Varying, Var, Reactor}
import com.glyph._scala.lib.util.reactive
import com.glyph._scala.lib.libgdx.actor.{ReactiveSize, DrawSprite}
import com.glyph._scala.lib.util.lifting.Clamp
