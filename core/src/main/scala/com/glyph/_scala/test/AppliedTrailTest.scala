...
import com.glyph._scala.lib.libgdx.gl.{BaseTrail, BaseStripBatch, ShaderHandler}
...
object TrailOps {
  ...
  def createManualParticles(f: () => BaseTrail)(texture: Texture)(n: Int)(implicit pool:com.glyph._scala.lib.util.pool.Pool[Sprite]): Seq[(Sprite, BaseTrail)] = 1 to n map {
    _ =>
